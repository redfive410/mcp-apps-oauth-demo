...
class SimpleAuthSettings(BaseSettings):
    ...
    # Demo user credentials (set via MCP_DEMO_USERNAME and MCP_DEMO_PASSWORD env vars)
    demo_username: str = "demo_user"
    demo_password: str  # Required - set via MCP_DEMO_PASSWORD or Cloud Run secret mount
